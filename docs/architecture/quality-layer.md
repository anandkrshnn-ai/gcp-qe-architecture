...
We maintain a flat, verified test suite mapped directly to our quality taxonomy:
...
| **[test_recovery.py](https://github.com/anandkrshnn-ai/gcp-incident-analysis-demo/blob/main/tests/test_recovery.py)** | **Recovery** | Simulates post-actuation telemetry regressions (e.g. high error rates) to verify that rollback gates trigger correctly. |
...
## 4. Failure Domain: Quality Intelligence Plane
